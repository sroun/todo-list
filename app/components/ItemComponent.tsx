...
const ItemComponent = (props: props, index:any) => {
	const { id, todo, isCompleted, createdAt } = props
	return <div key={index} className="bg-gray-100 py-2 px-3 rounded hover:bg-gray-50 duration-300 transition group relative overflow-hidden">
